...
const COPY = {
  en: {
    ...
    butlerSetupHint: "Butler is not configured yet. Enable it in Settings to start creating projects.",
    butlerSetupLink: "Enable Butler →",
  },
  ko: {
    loading: "대시보드 로딩 중...",
    ...
    butlerSetupHint: "Butler가 아직 설정되지 않았습니다. 설정에서 활성화하여 프로젝트 생성을 시작하세요.",
    butlerSetupLink: "Butler 활성화 →",
  },
} as const;
    ...
    <div className="h-full overflow-y-auto lg:overflow-hidden lg:flex lg:flex-col p-6">
      <div className="lg:grid lg:grid-cols-[1fr_340px] lg:gap-6 lg:flex-1 lg:min-h-0">
        ...
        <div className="lg:overflow-y-auto lg:min-h-0">
          {/* Butler is the primary Home surface */}
          {butlerEnabled ? (
            <ButlerChat />
          ) : (
            <div className="mb-4 border border-border bg-bg-surface px-4 py-4">
              <div className="text-[11px] text-text-muted mb-2">{t.butlerSetupHint}</div>
              <Link
